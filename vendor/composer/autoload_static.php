...
class ComposerStaticInite8ebe38d19b96375e5ea21477ea2041f
{
    ...
    public static $classMap = array (
        'ComSign\\Admin\\Admin' => __DIR__ . '/../..' . '/includes/Admin/Admin.php',
        'ComSign\\Admin\\DocumentsListTable' => __DIR__ . '/../..' . '/includes/Admin/DocumentsListTable.php',
        'ComSign\\Audit\\AuditLogger' => __DIR__ . '/../..' . '/includes/Audit/AuditLogger.php',
        'ComSign\\Database\\AuditRepository' => __DIR__ . '/../..' . '/includes/Database/AuditRepository.php',
        'ComSign\\Database\\DocumentRepository' => __DIR__ . '/../..' . '/includes/Database/DocumentRepository.php',
        'ComSign\\Database\\FieldRepository' => __DIR__ . '/../..' . '/includes/Database/FieldRepository.php',
        'ComSign\\Database\\SignerRepository' => __DIR__ . '/../..' . '/includes/Database/SignerRepository.php',
        'ComSign\\Email\\Mailer' => __DIR__ . '/../..' . '/includes/Email/Mailer.php',
        'ComSign\\Frontend\\SigningController' => __DIR__ . '/../..' . '/includes/Frontend/SigningController.php',
        'ComSign\\Pdf\\PdfComposer' => __DIR__ . '/../..' . '/includes/Pdf/PdfComposer.php',
        'ComSign\\Pdf\\PdfSigner' => __DIR__ . '/../..' . '/includes/Pdf/PdfSigner.php',
        'ComSign\\Plugin' => __DIR__ . '/../..' . '/includes/Plugin.php',
        'ComSign\\Services\\DocumentService' => __DIR__ . '/../..' . '/includes/Services/DocumentService.php',
        'ComSign\\Setup\\Activator' => __DIR__ . '/../..' . '/includes/Setup/Activator.php',
        'ComSign\\Setup\\Cron' => __DIR__ . '/../..' . '/includes/Setup/Cron.php',
        'ComSign\\Setup\\Deactivator' => __DIR__ . '/../..' . '/includes/Setup/Deactivator.php',
        'ComSign\\Setup\\Installer' => __DIR__ . '/../..' . '/includes/Setup/Installer.php',
        'ComSign\\Signature\\ElectronicSignatureProvider' => __DIR__ . '/../..' . '/includes/Signature/ElectronicSignatureProvider.php',
        'ComSign\\Signature\\SignatureProviderInterface' => __DIR__ . '/../..' . '/includes/Signature/SignatureProviderInterface.php',
        'ComSign\\Support\\Capabilities' => __DIR__ . '/../..' . '/includes/Support/Capabilities.php',
        'ComSign\\Support\\Settings' => __DIR__ . '/../..' . '/includes/Support/Settings.php',
        'ComSign\\Support\\Storage' => __DIR__ . '/../..' . '/includes/Support/Storage.php',
        'ComSign\\Support\\Tokens' => __DIR__ . '/../..' . '/includes/Support/Tokens.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInite8ebe38d19b96375e5ea21477ea2041f::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInite8ebe38d19b96375e5ea21477ea2041f::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInite8ebe38d19b96375e5ea21477ea2041f::$classMap;
